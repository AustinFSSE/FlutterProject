...
class ElectricalForum extends StatefulWidget {
  const ElectricalForum({super.key});

  @override
  State<ElectricalForum> createState() => _ElectricalForumState();
}

class _ElectricalForumState extends State<ElectricalForum> {
